...
pixi global install r-sandwich
```
...
It is possible to list all of the versions of `r-sandwich` available on your platform:
...
```
pixi search r-sandwich --channel conda-forge
```
